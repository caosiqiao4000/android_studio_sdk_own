...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        String releaseOver = context
                .getString(R.string.pull_to_refresh_tap_over);
        String labelDown = context
                .getString(R.string.pull_to_refresh_pull_down);

        // Add Loading Views
        if (mMode == MODE_PULL_DOWN_TO_REFRESH || mMode == MODE_BOTH) {
//            mHeaderLayout = new LoadingLayout(context,
//                    MODE_PULL_DOWN_TO_REFRESH, releaseLabel, releaseOver, //pullLabel啦啦啦啦
//                    refreshingLabel, a, getTag());
            mHeaderLayout   = new LoadingLayout(context,  //下拉刷新
                    MODE_PULL_DOWN_TO_REFRESH, releaseLabel, labelDown,
                    refreshingLabel, a, getTag());
