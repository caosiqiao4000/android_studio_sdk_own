...
public class QuickActionBar {
    ...
    /**
     * @param anchor 快捷操作框将要指示的视图组件。
     * @param idx    引发此QuickActionBar的ListItem的序号。
     * @param change , 对View改变方式
     */
    ...
    public void show() {
        ...
        // 显示/隐藏指定的箭头
        int arrowId = arrowOnTop ? com.qs.sdk.dialog.R.id.qa_arrow_up : R.id.qa_arrow_down;
     ...
     *
     * @param arrowShowId 最终显示在屏幕上的箭头ID。
     * @param marginLeft  为将箭头尖角设置在anchor中心点的X值处所需的位置值。
     */
     ...
     * @param coordinateX 响应图标中心点的X坐标值。
     * @param arrowOnTop  标识指示箭头是否在上。
     */
